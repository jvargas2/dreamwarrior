...
from dreamwarrior.models import Rainbow
...
class RainbowAgent():
    ...
    def __init__(self, args, env):
        ...
        self.online_net = Rainbow(args, self.action_space).to(device=args.device)
        ...
        self.target_net = Rainbow(args, self.action_space).to(device=args.device)
    ...
    def act_e_greedy(
        ...
        return np.random.randint(
            0, self.action_space) if np.random.random() < epsilon else self.act(
                state)
